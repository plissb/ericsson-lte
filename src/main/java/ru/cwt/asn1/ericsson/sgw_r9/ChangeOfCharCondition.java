...
public class ChangeOfCharCondition implements BerType, Serializable {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (qosNegotiated != null) {
			sublength = qosNegotiated.encode(reverseOS, true);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 2)) {
				...
				subCodeLength += qosNegotiated.decode(is, true);
				subCodeLength += berTag.decode(is);
			}
			if (berTag.tagNumber == 0 && berTag.tagClass == 0 && berTag.primitive == 0) {
				int nextByte = is.read();
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (dataVolumeGPRSUplink != null) {
			...
			sb.append("dataVolumeGPRSUplink: <empty-required-field>");
		}
		...
		if (dataVolumeGPRSDownlink != null) {
			...
			sb.append("dataVolumeGPRSDownlink: <empty-required-field>");
		}
