...
public class ChangeOfServiceConditionPGW implements BerType, Serializable {
	...
	public static class AFRecordInformation implements BerType, Serializable {
		...
		private List<ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation> seqOf = null;

		public AFRecordInformation() {
			seqOf = new ArrayList<ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation>();
		}
		...
		public List<ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation> getAFRecordInformation() {
			if (seqOf == null) {
				seqOf = new ArrayList<ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation>();
			}
			return seqOf;
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			if (length.val == -1) {
				while (true) {
					...
					ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation element = new ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (seqOf == null) {
				...
				Iterator<ru.cwt.asn1.ericsson.sgw_r9.AFRecordInformation> it = seqOf.iterator();
				if (it.hasNext()) {
	...
	public static class SidNew implements BerType, Serializable {
	...
	private ServiceConditionChangePGW serviceConditionChangePGW = null;
	...
	private SidNew sidNew = null;
	
	public ChangeOfServiceConditionPGW() {
	}

	public ChangeOfServiceConditionPGW(byte[] code) {
		this.code = code;
	}
	...
	public void setServiceConditionChangePGW(ServiceConditionChangePGW serviceConditionChangePGW) {
		this.serviceConditionChangePGW = serviceConditionChangePGW;
	}

	public ServiceConditionChangePGW getServiceConditionChangePGW() {
		return serviceConditionChangePGW;
	}
	...
	public void setSidNew(SidNew sidNew) {
		this.sidNew = sidNew;
	}

	public SidNew getSidNew() {
		return sidNew;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (sidNew != null) {
			sublength = sidNew.encode(reverseOS, true);
		...
		sublength = serviceConditionChangePGW.encode(reverseOS, true);
		codeLength += sublength;
		codeLength += BerLength.encodeLength(reverseOS, sublength);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 8)) {
				codeLength += length.decode(is);
				serviceConditionChangePGW = new ServiceConditionChangePGW();
				subCodeLength += serviceConditionChangePGW.decode(is, true);
				subCodeLength += berTag.decode(is);
			}
			if (berTag.tagNumber == 0 && berTag.tagClass == 0 && berTag.primitive == 0) {
				int nextByte = is.read();
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 22)) {
				codeLength += length.decode(is);
				sidNew = new SidNew();
				subCodeLength += sidNew.decode(is, true);
				subCodeLength += berTag.decode(is);
			}
			int nextByte = is.read();
			if (berTag.tagNumber != 0 || berTag.tagClass != 0 || berTag.primitive != 0
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (serviceConditionChangePGW != null) {
			sb.append("serviceConditionChangePGW: ").append(serviceConditionChangePGW);
		}
		else {
			sb.append("serviceConditionChangePGW: <empty-required-field>");
		}
		...
		if (sidNew != null) {
			...
			sb.append("sidNew: ");
			sidNew.appendAsString(sb, indentLevel + 1);
		}
