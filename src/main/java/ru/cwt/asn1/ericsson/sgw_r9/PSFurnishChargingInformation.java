...
public class PSFurnishChargingInformation implements BerType, Serializable {
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (pSFFDAppendIndicator != null) {
			sublength = pSFFDAppendIndicator.encode(reverseOS, true);
		...
		sublength = pSFreeFormatData.encode(reverseOS, true);
		codeLength += sublength;
		codeLength += BerLength.encodeLength(reverseOS, sublength);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 1)) {
				...
				subCodeLength += pSFreeFormatData.decode(is, true);
				subCodeLength += berTag.decode(is);
			}
			if (berTag.tagNumber == 0 && berTag.tagClass == 0 && berTag.primitive == 0) {
				int nextByte = is.read();
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 2)) {
				...
				subCodeLength += pSFFDAppendIndicator.decode(is, true);
				subCodeLength += berTag.decode(is);
			}
			int nextByte = is.read();
			if (berTag.tagNumber != 0 || berTag.tagClass != 0 || berTag.primitive != 0
